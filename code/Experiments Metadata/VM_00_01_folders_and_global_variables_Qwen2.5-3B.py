...
info_g_variables= {
  'SuperSet':f'Qwen2.5-3B_t_08_{dataset_to_use_env}',

  #Gen text
  'g_exp_gen':f'Qwen2.5-3B_t_08_{dataset_to_use_env}', #$ name of the generated text experiment
  'g_llm':'Qwen/Qwen2.5-3B',
  ...
  #Embeddings
  'g_exp_emb':f'emb_Qwen2.5-3B_t_08_E5_{dataset_to_use_env}', #$
  'g_embedding_model':'E5', #$
  'g_step_size_embeddings':1000,
  'g_batch_embeddings':500,

  #Similarity
  'g_exp_sim':f'sim_Qwen2.5-3B_E5_t_08_{dataset_to_use_env}', #$ name infofile - similarity 
