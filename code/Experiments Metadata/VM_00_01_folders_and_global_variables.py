...
# Retrieve llm name, embedding model and dataset name from environment variable
llm_to_use_env = os.getenv("llm_to_use_env")
llm_to_use_url_env = os.getenv("llm_to_use_url_env")
emb_to_use_env = os.getenv("emb_to_use_env")
...
info_g_variables= {
  'SuperSet':f'{llm_to_use_env}_t_08_{dataset_to_use_env}',

  #Gen text
  'g_exp_gen':f'{llm_to_use_env}_t_08_{dataset_to_use_env}', #$ name of the generated text experiment
  'g_llm':llm_to_use_url_env,
  ...
  #Embeddings
  'g_exp_emb':f'emb_{llm_to_use_env}_t_08_{emb_to_use_env}_{dataset_to_use_env}', #$
  'g_embedding_model':emb_to_use_env, #$
  'g_step_size_embeddings':1000,
  'g_batch_embeddings':50,

  #Similarity
  'g_exp_sim':f'sim_{llm_to_use_env}_{emb_to_use_env}_t_08_{dataset_to_use_env}', #$ name infofile - similarity 
